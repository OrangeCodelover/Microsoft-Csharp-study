...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            // readResult = Console.ReadLine();
            // Console.WriteLine($"Enter an age for ID #: {readResult}");

            for (int i=0 ; i < maxPets; i++)
            {
                int found = 0;
                string currentPetAge;
                int currentPetAgeInt = 0;
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    found = ourAnimals[i, 2].IndexOf(": ");
                    currentPetAge = ourAnimals[i, 2].Substring(found + 2);
                    if (currentPetAge =="?")
                    {
                        do
                        {
                            ...
                            if (readResult != null)
                            {
                                validEntry = int.TryParse(readResult, out currentPetAgeInt);
                            }                          
                        }
                        while (!validEntry);
        ...
        case "4":
            ...
            for (int i=0 ; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    found = ourAnimals[i, 3].IndexOf(": ");
                    petNickname = ourAnimals[i, 3].Substring(found + 2);
                    if (petNickname == "")
                    {
                        do
                        {
